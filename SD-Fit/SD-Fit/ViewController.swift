...
class ViewController: UIViewController {
    ...
    @IBAction func Button(_ sender: Any) {
        let vidURL = URL(string:"https://firebasestorage.googleapis.com/v0/b/sdfit-4b75a.appspot.com/o/SD%20Fit_MMA%20Warm%20Up.mp4?alt=media&token=f4c505e9-24f4-49f6-9d94-85f21a979de2");
        playURL(vidURL: vidURL!)
    }
    
    
    @IBAction func Button2(_ sender: Any) {
        let vidURL = URL(string:"https://firebasestorage.googleapis.com/v0/b/sdfit-4b75a.appspot.com/o/SD%20Fit_Muy%20Thai%20Mitts%20Combos.mp4?alt=media&token=085c7b74-ff38-4db3-834e-41c311655162");
        playURL(vidURL: vidURL!)
    }
    
    @IBAction func Button3(_ sender: Any) {
        let vidURL = URL(string:"https://firebasestorage.googleapis.com/v0/b/sdfit-4b75a.appspot.com/o/SD%20Fit_MMA%20Body%20Weight%20Descending%20Ladder%20Workout.mp4?alt=media&token=d2755044-d73b-416a-8b08-ee06ae14c6f1");
        playURL(vidURL: vidURL!)
    }
    @IBAction func Button4(_ sender: Any) {
        let vidURL = URL(string:"");
        playURL(vidURL: vidURL!)
    }
